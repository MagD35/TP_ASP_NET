...
namespace TP2
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Afficher l'auteur qui a écris le plus de livre
            //var auteurPlusDeLivre = 

            //Console.WriteLine("Afficher l'auteur qui a écris le plus de livre");
            //foreach (var auteur in auteurPlusDeLivre)
            //{
